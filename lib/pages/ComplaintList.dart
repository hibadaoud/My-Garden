...
List? complaints;
  ...
  void getcomplaint(String userID) async{
    var reqBody = {
      "submitter": userID
    };

    var responce = await http.post(Uri.parse(complaintUser),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                          '${complaints![index]['submitter']['firstName']}''${complaints![index]['submitter']['lastName']}',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                          ),
