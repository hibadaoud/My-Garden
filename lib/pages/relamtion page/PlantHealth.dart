...
class PlantHealth extends StatefulWidget {
  const PlantHealth({Key? key}): super(key:key);
...
class _PlantHealthState extends State<PlantHealth> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 4,
        title: Text('Plant Health', style: TextStyle(color: Colors.white)),
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            settingTile(context, 'Pest Infestation'),
            SizedBox(height: 15,),
            settingTile(context, 'Disease Outbreaks'),
            SizedBox(height: 15,),
            settingTile(context, 'Pesticide Usage'),
            SizedBox(height: 15,),
  ...
  void navigateToReclamationForm(String type) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => NewReclamationForm(type: type, complaintTypes: getComplaintTypesForType(type))),
    );
  }
  ...
  List<String> getComplaintTypesForType(String type) {
    switch (type) {
      case 'Pest Infestation':
        return ['Pest Infestation', 'Disease Outbreaks','Pesticide Usage','Other'];
      case 'Disease Outbreaks':
        return ['Pest Infestation', 'Disease Outbreaks','Pesticide Usage', 'Other'];
      case 'Pesticide Usage':
        return ['Pest Infestation', 'Disease Outbreaks','Pesticide Usage','Other'];
      case 'Other':
        return ['Pest Infestation', 'Disease Outbreaks','Other'];
      default:
        return [];
    }
  }
